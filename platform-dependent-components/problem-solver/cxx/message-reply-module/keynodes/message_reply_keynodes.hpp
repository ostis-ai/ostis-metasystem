...
public:
  ...
  static inline ScKeynode const message_processing_program{"message_processing_program", ScType::ConstNodeStructure};
  static inline ScKeynode const languages{"languages", ScType::ConstNodeClass};
