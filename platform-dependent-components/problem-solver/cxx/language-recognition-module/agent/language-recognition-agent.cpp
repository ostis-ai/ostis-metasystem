...
bool LanguageRecognitionAgent::checkAction(ScAddr const & actionAddr)
{
  return m_context.HelperCheckEdge(LanguageRecognitionKeynodes::action_language_recognition, actionAddr, ScType::EdgeAccessConstPosPerm);
}
