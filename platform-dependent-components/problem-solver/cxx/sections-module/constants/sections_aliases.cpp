...
std::string const sections_aliases::SECTION_EDGE = "_section_edge";
std::string const sections_aliases::SECTION_NODE = "_section";
std::string const sections_aliases::PREVIOUS_SECTION_ARC = "_previous_section_arc";
std::string const sections_aliases::NEXT_SECTION_ARC = "_next_section_arc";
