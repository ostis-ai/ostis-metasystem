...
from modules.authoriseModule.AuthoriseModule import AuthoriseModule
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--protocol",
        type=str,
        dest=SC_SERVER_PROTOCOL,
        default=SC_SERVER_PROTOCOL_DEFAULT,
        help="Sc-server protocol",
    )
    parser.add_argument(
        "--host",
        type=str,
        dest=SC_SERVER_HOST,
        default=SC_SERVER_HOST_DEFAULT,
        help="Sc-server host",
    )
    parser.add_argument(
        "--port",
        type=int,
        dest=SC_SERVER_PORT,
        default=SC_SERVER_PORT_DEFAULT,
        help="Sc-server port",
    )
