...
from sc_kpm.utils.action_utils import create_action_answer, finish_action_with_status
...
class ExampleAgent(ScAgentClassic):
    ...
    def run(self, action_node: ScAddr) -> ScResult:
        ...
        link = create_link(
            "Example agent is called",
            ScLinkContentType.STRING,
            link_type=sc_types.LINK_CONST,
        )
