...
\begin{scnrelfromvector}{задачи}
  \scnitem{поиск ответного действия для класса сообщения}
...
\begin{scnrelfromvector}{алгоритм}
  ...
  \scnfileitem{Проверка принадлежности класса сообщения на принадлежность классу \textit{concept\_ask\_ai\_message\_class}}
